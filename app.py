...
# Initialize the client with the model ID and your token
    ...
    doc.add_heading("Questions Answers")
...
# Initialize the client with the model ID and your token
    ...
    # print(report)
    print("########################")
    response = client.text_generation(prompt, max_new_tokens=2000, temperature=0.5, top_p=0.9)
    print(response)
    print("########################")
...
def generate_report_fb():
    ...
    api_token = "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"
# Initialize the client with the model ID and your token
    client2 = InferenceClient(model=model_id, token=api_token)
    user_input = request.json.get('user_input', '')
    ...
    print("##############################")
    response = client2.text_generation(prompt, max_new_tokens=1500, temperature=0.5, top_p=0.9)
    print(response)
    print("##############################")
    # Create a Word document
    doc = Document()
    ...
    #         doc.add_paragraph("")
    doc.add_heading("Fill in the Blanks")
    doc.add_paragraph(response)
